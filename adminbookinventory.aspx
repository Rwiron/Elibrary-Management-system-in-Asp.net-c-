...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--making custom script for function of readURL for onchange event--%>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <%--we are going to make change for file upload and change will only made on fronted 
                         not backend to avoid overload of server we will use on change event and we call
                             readURL function--%>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                                        ...
                                        <asp:ListItem Text="Kinyarwanda" Value="Hindi" />
                                        <asp:ListItem Text="French" Value="Marathi" />
                                        <asp:ListItem Text="Kiswahili" Value="French" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <%--for any large screen devices lg--%>
                                                        <div class="col-lg-10">
                                                            <div class="row">
                                                                <div class="col-12">
                                                        ...
                                                        <%--so everytime the datasource refresh everytime it releoded--%>
                                                        <div class="col-lg-2">
